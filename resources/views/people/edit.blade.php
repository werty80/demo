<x-layout>
    ...
    <x-slot:action>
        <a href="javascript:history.back()" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            People
        </a>
    </x-slot:action>
    ...
    <form method="POST" action="/peoples/{{ $people->id }}" id="delete-form" class="hidden">
        @csrf
        @method('DELETE')
    </form>
</x-layout>
