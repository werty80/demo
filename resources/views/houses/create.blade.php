            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <select name="village_id" id="village" class="block w-full rounded-md bg-white pl-3 pr-10 py-1.5 text-gray-900 focus:outline-none sm:text-sm" required>
                                <option value="">Select an Village</option>
                                @foreach ($villages as $village)
                                    <option
                                        value="{{ old('village_id', $village->id) }}"
